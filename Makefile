...
CFLAGS = -fno-pic -Wno-error=pointer-arith -static -fno-builtin -fno-strict-aliasing -Wall -Wno-error=deprecated-declarations -MD -m32 -ggdb  -Werror -fno-omit-frame-pointer -std=gnu11 -pedantic
...
tar:
	rm -rf /tmp/qwin
	mkdir -p /tmp/qwin
	cp dist/* dist/.gdbinit.tmpl /tmp/qwin
	(cd /tmp; tar cf - qwin) | gzip >qwin-rev5.tar.gz
