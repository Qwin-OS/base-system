...
_mkdir:     формат файла elf32-i386
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 417:	0f b6 80 e0 13 00 00 	movzbl 0x13e0(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 552:	75 07                	jne    55b <printf+0xe1>
          s = "(null)";
 554:	c7 45 f4 cd 0f 00 00 	movl   $0xfcd,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 619:	a1 fc 13 00 00       	mov    0x13fc,%eax
...
free(void *ap)
{
 ...
 6e4:	a3 fc 13 00 00       	mov    %eax,0x13fc
}
 6e9:	c9                   	leave  
 6ea:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 741:	83 c4 10             	add    $0x10,%esp
  return freep;
 744:	a1 fc 13 00 00       	mov    0x13fc,%eax
}
 749:	c9                   	leave  
 74a:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 75d:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 760:	a1 fc 13 00 00       	mov    0x13fc,%eax
 765:	89 45 f0             	mov    %eax,-0x10(%ebp)
 768:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 76c:	75 23                	jne    791 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 76e:	c7 45 f0 f4 13 00 00 	movl   $0x13f4,-0x10(%ebp)
 775:	8b 45 f0             	mov    -0x10(%ebp),%eax
 778:	a3 fc 13 00 00       	mov    %eax,0x13fc
 77d:	a1 fc 13 00 00       	mov    0x13fc,%eax
 782:	a3 f4 13 00 00       	mov    %eax,0x13f4
    base.s.size = 0;
 787:	c7 05 f8 13 00 00 00 	movl   $0x0,0x13f8
 78e:	00 00 00 
  }
 ...
 7e4:	a3 fc 13 00 00       	mov    %eax,0x13fc
      return (void*)(p + 1);
 ...
 7ef:	eb 3b                	jmp    82c <malloc+0xe1>
    ...
    if(p == freep)
 7f1:	a1 fc 13 00 00       	mov    0x13fc,%eax
